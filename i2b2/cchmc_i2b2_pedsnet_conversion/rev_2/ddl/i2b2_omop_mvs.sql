...
--
--=============================================================================
DROP MATERIALIZED VIEW OMOP_ETL.MV_OMOP_DX_CODES
/
CREATE MATERIALIZED VIEW OMOP_ETL.MV_OMOP_DX_CODES
TABLESPACE I2B2DAT
PCTUSED    0
PCTFREE    0
INITRANS   2
...
SELECT STCM.SOURCE_CODE,
       ...
       STCM.VALID_END_DATE,
       STCM.INVALID_REASON
  FROM OMOP_ETL.SOURCE_TO_CONCEPT_MAP STCM
       INNER JOIN OMOP_ETL.VOCABULARY SV
          ON STCM.SOURCE_VOCABULARY_ID = SV.VOCABULARY_ID
       INNER JOIN OMOP_ETL.VOCABULARY TV
          ON STCM.TARGET_VOCABULARY_ID = TV.VOCABULARY_ID
       INNER JOIN OMOP_ETL.CONCEPT C ON STCM.TARGET_CONCEPT_ID = C.CONCEPT_ID
...
/
COMMENT ON MATERIALIZED VIEW OMOP_ETL.MV_OMOP_DX_CODES IS 'snapshot table for snapshot OMOP_ETL.MV_OMOP_DX_CODES'
/
