...
CREATE TABLE cohort (
	cohort_id BIGINT NOT NULL IDENTITY(1,1), 
...
CREATE TABLE drug_cost (
	drug_cost_id BIGINT NOT NULL IDENTITY(1,1), 
...
CREATE TABLE procedure_cost (
	procedure_cost_id BIGINT NOT NULL IDENTITY(1,1), 
