...
condition_start_date | Yes | Datetime | The date and time when the instance of the condition is recorded. | No date shifting.  Full date and time. If there is no time associated with the date assert midnight.
