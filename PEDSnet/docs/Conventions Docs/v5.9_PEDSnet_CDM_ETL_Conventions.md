# ETL Conventions for use with PEDSnet CDM v5.9 OMOP V5.4
...
Version v5.9 of the PEDSnet CDM reflects the ETL processes developed after several iterations of network development. As such, it proposes to align with version 7.0 of the PCORnet CDM.
...
2. The PEDSnet CDM v5.9 is based on the Observational Medical Outcomes Partnership (OMOP) data model, version 5.4. 
...
#### [1.1 Person](v5.9_PEDSnet_CDM_ETL_Conventions.md#11-person-1)

#### [1.2 Death](v5.9_PEDSnet_CDM_ETL_Conventions.md#12-death-1)

#### [1.3 Location](v5.9_PEDSnet_CDM_ETL_Conventions.md#13-location-1)

#### [1.4 Care Site](v5.9_PEDSnet_CDM_ETL_Conventions.md#14-care_site)

#### [1.5 Provider](v5.9_PEDSnet_CDM_ETL_Conventions.md#15-provider-1)

#### [1.6 Visit Occurrence ](v5.9_PEDSnet_CDM_ETL_Conventions.md#16-visit_occurrence)

#### [1.7 Condition Occurrence](v5.9_PEDSnet_CDM_ETL_Conventions.md#17-condition_occurrence)

#### [1.8 Procedure Occurrence](v5.9_PEDSnet_CDM_ETL_Conventions.md#18-procedure_occurrence)

#### [1.9 Observation](v5.9_PEDSnet_CDM_ETL_Conventions.md#19-observation-1)

#### [1.10 Observation Period](v5.9_PEDSnet_CDM_ETL_Conventions.md#110-observation_period)

#### [1.11 Drug Exposure](v5.9_PEDSnet_CDM_ETL_Conventions.md#111-drug_exposure)

#### [1.12 Measurement](v5.9_PEDSnet_CDM_ETL_Conventions.md#112-measurement-1)

#### [1.13 Fact Relationship](v5.9_PEDSnet_CDM_ETL_Conventions.md#113-fact_relationship)

#### [1.14 Visit Payer](v5.9_PEDSnet_CDM_ETL_Conventions.md#114-visit_payer)

#### [1.15 Measurement Organism](v5.9_PEDSnet_CDM_ETL_Conventions.md#115-measurement_organism)

#### [1.16 ADT Occurrence](v5.9_PEDSnet_CDM_ETL_Conventions.md#116-adt_occurrence)

#### [1.17 Immunization](v5.9_PEDSnet_CDM_ETL_Conventions.md#117-immunization-1)

#### [1.18 Device Exposure](v5.9_PEDSnet_CDM_ETL_Conventions.md#118-device_exposure)

#### [1.19 Location History](v5.9_PEDSnet_CDM_ETL_Conventions.md#119-location_history)

#### [1.20 Hash Token](v5.9_PEDSnet_CDM_ETL_Conventions.md#120-hash_token)

#### [1.21 Specialty](v5.9_PEDSnet_CDM_ETL_Conventions.md#121-specialty-1)

#### [1.22 Location FIPS](v5.9_PEDSnet_CDM_ETL_Conventions.md#122-location_fips)

#### [1.23 Cohort](v5.9_PEDSnet_CDM_ETL_Conventions.md#123-cohort-1)

#### [1.24 Cohort Definition](v5.9_PEDSnet_CDM_ETL_Conventions.md#124-cohort_definition)

#### [Appendix](v5.9_PEDSnet_CDM_ETL_Conventions.md#a1-abms-specialty-category-to-omop-v5-specialty-mapping)
...
- See [Note 11 of Observation](v5.9_PEDSnet_CDM_ETL_Conventions.md#19-observation-1) for more details.

### Note 3:

If maternal and delivery information exists in your source EHR system, and both the mother and child are within the PEDSnet inclusion criteria, then a mother-child relationship can be defined using the [Fact Relationship](v5.9_PEDSnet_CDM_ETL_Conventions.md#113-fact_relationship) table as follows:
...
**Table 1: Valid Observation concept IDs and Value as concept IDs for PEDSnet v5.9.** 
...
- Blood Pressure Systolic and Diastolic Blood Pressure Values will be mapped using the fact relationship table. See [Note 2 in the Measurement section](v5.9_PEDSnet_CDM_ETL_Conventions.md#measurement-note-2) for instructions.
- ER Visits that result in an Inpatient Encounter will be mapped using the fact relationship table. See [Additional Notes in the Visit Occurrence section](v5.9_PEDSnet_CDM_ETL_Conventions.md#161-additional-notes) for instructions.
- Tobacco, smoking and tobacco type associations will be mapped using the fact relationship table. See [Note 4 in the Observation section](v5.9_PEDSnet_CDM_ETL_Conventions.md#observation-note-4) for instructions.
- The inpatient medication orders and administrations linking is ***optional***. See [Note 8 in the Drug_Exposure section](v5.9_PEDSnet_CDM_ETL_Conventions.md#111-drug-exposure-1)
...
- Mother Child relationships will be mapped using the fact relationship table. See [Note 3 in the Person section](v5.9_PEDSnet_CDM_ETL_Conventions.md#11-person-1) for instructions.
<br>
