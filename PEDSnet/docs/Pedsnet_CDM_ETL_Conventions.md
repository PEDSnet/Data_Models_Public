...
measurement_result_date| No | Provide When Available| Date | This field applies to Lab Orders only. This is the date the lab resulted was ordered in the source. | No date shifting.
