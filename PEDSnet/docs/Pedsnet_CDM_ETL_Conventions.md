...
**Note 2:**
For Observation Stay visits, please discern what defines an observation visit at your site. However, only map to the observation visit type if the patient leaves the hospital or is discharged from what has been determined to be an observation visit. For sites splitting visits, ED->Observation visits are only to be mapped as Observation Stay Visits. The split in this case is not required.
