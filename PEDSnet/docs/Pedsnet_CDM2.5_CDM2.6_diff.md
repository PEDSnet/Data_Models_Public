...
- observation_period.observation_period_start_time will remain unchanged. *(Name change problematic for ORACLE DDL)*
- observation_period.observation_period_end_time will remain unchanged. *(Name change problematic for ORACLE DDL)*
