...
To verify PEDSnet-format data, use `-model pedsnet` and `-version 4.8.0` as arguments when running the validator. 
...
- v4.8.0 Core Vocabulary: Please contact the DCC for more information.
