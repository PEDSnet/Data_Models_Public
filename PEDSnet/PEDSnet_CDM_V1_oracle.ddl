...
CREATE TABLE location (
	...
	state CHAR(2), 
	zip VARCHAR(9 CHAR), 
	address_1 VARCHAR(100 CHAR), 
	address_2 VARCHAR(100 CHAR), 
	city VARCHAR(50 CHAR), 
	county VARCHAR(50 CHAR), 
	location_source_value VARCHAR(300 CHAR), 
...
CREATE TABLE organization (
	...
	location_id BIGINT, 
	organization_source_value VARCHAR(50 CHAR) NOT NULL, 
	place_of_service_source_value VARCHAR(100 CHAR), 
...
CREATE TABLE care_site (
	...
	place_of_service_concept_id INTEGER, 
	location_id BIGINT, 
	care_site_source_value VARCHAR(100 CHAR) NOT NULL, 
	place_of_service_source_value VARCHAR(100 CHAR), 
...
CREATE TABLE provider (
	...
	provider_source_value VARCHAR(100 CHAR) NOT NULL, 
	specialty_source_value VARCHAR(50 CHAR), 
...
CREATE TABLE person (
	...
	person_source_value VARCHAR(100 CHAR), 
	gender_source_value VARCHAR(50 CHAR), 
	race_source_value VARCHAR(50 CHAR), 
	ethnicity_source_value VARCHAR(50 CHAR), 
...
CREATE TABLE death (
	...
	cause_of_death_source_value VARCHAR(100 CHAR), 
...
CREATE TABLE visit_occurrence (
	...
	provider_id BIGINT, 
	care_site_id BIGINT, 
	visit_source_value VARCHAR(100 CHAR), 
...
CREATE TABLE payer_plan_period (
	...
	payer_source_value VARCHAR(100 CHAR), 
	plan_source_value VARCHAR(100 CHAR), 
	family_source_value VARCHAR(100 CHAR), 
...
CREATE TABLE condition_occurrence (
	...
	visit_occurrence_id BIGINT, 
	condition_source_value VARCHAR(100 CHAR), 
...
CREATE TABLE observation (
	...
	value_as_string VARCHAR(60 CHAR), 
	value_as_concept_id INTEGER, 
	unit_concept_id INTEGER, 
	associated_provider_id BIGINT, 
	visit_occurrence_id BIGINT, 
	relevant_condition_concept_id INTEGER, 
	observation_source_value VARCHAR(100 CHAR), 
	unit_source_value VARCHAR(100 CHAR), 
...
CREATE TABLE procedure_occurrence (
	...
	visit_occurrence_id BIGINT, 
	relevant_condition_concept_id INTEGER, 
	procedure_source_value VARCHAR(100 CHAR), 
...
CREATE TABLE procedure_cost (
	...
	payer_plan_period_id BIGINT, 
	disease_class_source_value VARCHAR(100 CHAR), 
	revenue_code_source_value VARCHAR(100 CHAR), 
