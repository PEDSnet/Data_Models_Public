...
ALTER TABLE visit_payer ADD CONSTRAINT xpk_visit_payer PRIMARY KEY NONCLUSTERED ( visit_payer_id ) ;
...
ALTER TABLE visit_payer ADD CONSTRAINT fpk_visit_payer FOREIGN KEY (visit_occurrence_id) REFERENCES visit_occurrence (visit_occurrence_id);
