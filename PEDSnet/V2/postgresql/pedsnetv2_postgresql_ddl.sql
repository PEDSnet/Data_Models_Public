...
CREATE TABLE observation_period 
    ( 
     ...
     observation_period_start_time		TIMESTAMP		NOT NULL , 
     observation_period_end_time		TIMESTAMP		NOT NULL ,
...
CREATE TABLE drug_exposure 
    ( 
     ...
     drug_exposure_start_time		TIMESTAMP			NULL , 
     drug_exposure_end_time			TIMESTAMP			NULL , 
...
CREATE TABLE condition_occurrence 
    ( 
     ...
     condition_start_time			TIMESTAMP			NULL , 
     condition_end_time				TIMESTAMP			NULL , 
...
CREATE TABLE visit_payer 
    (
	 visit_payer_id                 SERIAL          NOT NULL, 
	 visit_occurrence_id            INTEGER         NOT NULL, 
