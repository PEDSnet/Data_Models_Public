...
CREATE TABLE observation_period 
    ( 
     ...
     observation_period_start_time		DATE		NOT NULL , 
     observation_period_end_time		DATE		NOT NULL ,
...
CREATE TABLE drug_exposure 
    ( 
     ...
     drug_exposure_start_time		DATE			NULL , 
     drug_exposure_end_time			DATE			NULL , 
...
CREATE TABLE condition_occurrence 
    ( 
     ...
     condition_start_time			DATE			NULL , 
     condition_end_time				DATE			NULL , 
...
CREATE TABLE visit_payer 
    (
	 visit_payer_id                 INTEGER         NOT NULL, 
	 visit_occurrence_id            INTEGER         NOT NULL, 
